...
\usepackage{geometry}
\usepackage{amsmath}
\usepackage{float} % Added for better image positioning
\usepackage{pdfpages}
...
\section{Latar Belakang Permasalahan}
...
\section{Kriteria, Bobot Kriteria, dan Benefit/Cost}
...
\subsection{Implementasi Basis Data Kriteria}
...
\subsection{Implementasi Basis Data Kandidat}
...
\section{Langkah Perhitungan GDSS}

\subsection{Evaluasi Individu (TOPSIS)}
...
\subsubsection{Fungsi \texttt{calculateByUser(\$userId)} di \texttt{TopsisService.php}}
...
\subsubsection{Analisis Proses TOPSIS}
...
\subsubsection{Implementasi Basis Data TOPSIS}

\textbf{Tabel \texttt{evaluations}}
...
\textbf{Tabel \texttt{topsis\_results}}
...
\subsection{Konsensus Kelompok (Borda Count)}
...
\subsubsection{Fungsi \texttt{calculateConsensus(\$userId)} di \texttt{BordaService.php}}
...
\subsubsection{Analisis Logika Borda}
...
\subsubsection{Implementasi Basis Data Borda}

\textbf{Tabel \texttt{consensus\_logs}}
...
\textbf{Tabel \texttt{borda\_results}}
...
\subsection{Arsitektur Pengguna (Tabel Users)}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/login.jpeg}
    \caption{Halaman Login Aplikasi}
    \label{fig:login}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/admin dashboard.jpeg}
    \caption{Dashboard Utama Administrator}
    \label{fig:admin_dash}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/alternatif and criteria edit page.jpeg}
    \caption{Halaman Edit Alternatif dan Kriteria}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/decision maker inputting evaulations.jpeg}
    \caption{Formulir Input Penilaian Decision Maker}
    \label{fig:evaluation_input}
\end{figure}

Berikut adalah tampilan dashboard dari perspektif pengambil keputusan yang berbeda:

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/manager dashboard page.jpeg}
    \caption{Dashboard Area Manager}
    \label{fig:manager_dash}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/store head manager hes here as a decision maker too.jpeg}
    \caption{Dashboard Store Manager (Kepala Toko)}
    \label{fig:store_dash}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/hr guys dashboard hes here as a decision maker.jpeg}
    \caption{Dashboard HR Department}
    \label{fig:hr_dash}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/status page containing total alternatives evaluation status and borda consensus status.jpeg}
    \caption{Halaman Status Penilaian dan Konsensus}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/consensus results naming farel as the best candidate.jpeg}
    \caption{Hasil Akhir Konsensus (Pemenang Terpilih)}
    \label{fig:consensus_result}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/candidates final ranking.jpeg}
    \caption{Tabel Peringkat Final Seluruh Kandidat}
